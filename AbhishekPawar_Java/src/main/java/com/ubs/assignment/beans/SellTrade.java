...
public class SellTrade implements Trade {
	...
	public SellTrade(String instrumentName, long transactionQty) {
		super();
	...
	public String toString() {
		return "SellTrade [transactionId=" + transactionId + ", instrumentName=" + instrumentName + ", transactionType="
